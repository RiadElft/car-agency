      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">AutoPrestige</h3>
            <p className="text-gray-300 mb-4">
                              Votre partenaire de confiance pour l&apos;achat de véhicules haut de gamme. 
              Nous vous offrons une expérience d&apos;achat exceptionnelle avec un service personnalisé.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/vehicules" className="text-gray-300 hover:text-white transition-colors">Véhicules</Link></li>
